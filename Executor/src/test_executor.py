...
# gcloud storage buckets add-iam-policy-binding gs://inspecta-file-bucket --member="serviceAccount:firebase-adminsdk-fbsvc@inspecta-360.iam.gserviceaccount.com" --role="roles/storage.objectUser"
# ====================================================
