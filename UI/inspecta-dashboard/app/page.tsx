            ...
            {!isFiltersCollapsed && (
              <div className="px-3 py-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  {/* Quick Filters / Additional Filters */}
                  <div className="p-3 rounded-xl border border-slate-200/80 bg-white/60 backdrop-blur-sm shadow-sm flex flex-col justify-between">
                    ...
                    {(daysFilter !== '' || assignedToMe || withVideoOnly) && (
                      <button
                        ...
                        className="text-xs text-red-500 hover:text-red-700 font-medium hover:underline cursor-pointer flex items-center gap-1 mt-3 pt-2 border-t border-slate-200/80 w-full justify-center"
                        title="Reset Quick Filters"
                      >
                        <RotateCcw className="w-3.5 h-3.5" />
                        <span>Reset Quick Filters</span>
                      </button>
                    )}
                  </div>
                </div>
