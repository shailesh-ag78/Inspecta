...
export function ActionOptions({
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2.5 border-t border-slate-100 pt-4">
        <h4 className={`${labelHeaderStyle} flex items-center gap-2`}>
          <span className="text-base bg-slate-50 p-1.5 rounded-lg border border-slate-100/70 text-lg inline-flex items-center justify-center w-8 h-8 select-none">📋</span>
