    ...
    <div className="fixed inset-0 z-[60] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="max-w-[400px] w-full bg-white rounded-2xl shadow-2xl p-6 flex flex-col gap-4">
        <div className="flex items-center gap-3 text-rose-600">
          ...
          <h3 className="text-base font-bold">Permissions Required</h3>
        </div>
        ...
        <div className="flex justify-end mt-2">
          <button
            ...
            className="px-5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-lg text-xs transition-colors"
          >
            Close
          </button>
        </div>
